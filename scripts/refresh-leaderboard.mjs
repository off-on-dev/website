...
const ADVENTURE_CATEGORIES = {
  ...
  "adventure-accessibility-nightmare": { categoryId: 0, has_beginner: true, has_intermediate: false, has_expert: false, has_single: false }, // TODO: set categoryId — look up at https://community.offon.dev/categories.json
