...
export const ADVENTURES: Adventure[] = [
  ...
  },
  {
    ...
    title: "RPG Battles",
    month: "SIMULATOR",
    story: "Face real-world open source dilemmas in turn-based Pokémon-style combat. Make strategic decisions and fight vendor lock-in, tech debt, and corporate monopolies.",
    tags: ["Strategy", "Open Source", "Vendor Lock-in", "Compliance"],
    forks: 0,
    ...
    levels: [
      {
        ...
        learnings: ["Open source vs proprietary trade-offs", "Vendor lock-in risks", "Supply chain security", "AI governance decisions"],
        codespacesUrl: "",
        discussionUrl: "",
      },
    ],
    simulatorRoute: "/simulator/rpg",
  },
  {
    id: "simulator-strategic",
    title: "Strategic Simulation",
    month: "SIMULATOR",
    story: "Lead an OSPO through three years of strategic decisions. Position your open source program, navigate AI adoption, and respond to regulation. No scores — only trade-offs.",
    tags: ["OSPO", "Strategy", "Digital Sovereignty", "Leadership"],
    forks: 0,
    status: "live" as const,
    category: "non-technical" as const,
    levels: [
      {
        id: "play",
        name: "What Is the OSPO Actually For?",
        difficulty: "Intermediate" as const,
        learnings: ["OSPO positioning strategies", "AI governance decisions", "Regulatory compliance trade-offs", "Developer trust vs executive confidence"],
        codespacesUrl: "",
        discussionUrl: "",
      },
    ],
    simulatorRoute: "/simulator/strategic",
  },
  {
    id: "simulator-open-future",
    title: "Open Future",
    month: "SIMULATOR",
    story: "Build and lead an OSPO over five years at Europa GmbH. Manage budgets, hire teams, navigate crises, and pursue victory paths in this deep strategy simulation.",
    tags: ["OSPO", "Deep Strategy", "Resource Management", "Ecosystem"],
    forks: 0,
    status: "live" as const,
    category: "non-technical" as const,
    levels: [
      {
        id: "play",
        name: "The OSPO Strategy Simulator",
        difficulty: "Expert" as const,
        learnings: ["OSPO resource management", "Tech tree & maturity progression", "Crisis response strategies", "Ecosystem building & community engagement"],
        codespacesUrl: "",
        discussionUrl: "",
      },
    ],
    simulatorRoute: "/simulator/open-future",
  },
];
