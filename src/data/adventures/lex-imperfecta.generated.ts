  ...
  levels: [
    {
      ...
      audience: "Platform engineers, <abbr title=\"Site Reliability Engineers\" tabindex=\"0\">SREs</abbr>, and developers curious about Kubernetes security — no prior Kyverno experience needed, but familiarity with basic <code>kubectl</code> and YAML will help.",
      learnings: [
...
<p>This re-applies the policies and re-deploys all workloads so you immediately see the effect of your changes.</p>` },
    ...
    },
    {
      ...
      audience: "Platform engineers and <abbr title=\"Site Reliability Engineers\" tabindex=\"0\">SREs</abbr> who have some familiarity with Kyverno, ideally after completing the Beginner level. You should be comfortable reading Kubernetes YAML and basic kubectl commands.",
      learnings: [
...
Archivist role can read the secret. Kubernetes <abbr title="Role-Based Access Control" tabindex="0">RBAC</abbr> can restrict which service accounts may
<code>get</code> a secret at the <abbr title="Application Programming Interface" tabindex="0">API</abbr> level, a complementary layer that admission control alone cannot
provide.</p>` },
      ],
      helpfulLinks: [
