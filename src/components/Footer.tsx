  ...
  return (
    <footer className="bg-background border-t border-border px-6 sm:px-8 md:px-16 lg:px-20">
      <div className="mx-auto max-w-6xl py-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
        ...
        <div>
          <div className="mb-4">
            <img src={theme === "dark" ? logoDark : logoLight} alt={SITE_NAME} width={104} height={26} loading="lazy" decoding="async" className="h-5" />
          </div>
          <p className="font-sans text-sm text-dim leading-relaxed md:max-w-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12">
            ...
            <nav aria-label="Explore">
              ...
              <div className="flex flex-col">
                ...
                <NavLink to="/handbook/" className={linkCls}>Handbook</NavLink>
                <NavLink to="/about/" className={linkCls}>About</NavLink>
                <NavLink to="/brand/" className={linkCls}>Brand</NavLink>
              </div>
            </nav>
            {/* Community */}
      ...
      <div className="border-t border-border py-4">
        <div className="mx-auto max-w-6xl flex flex-col items-center gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          <span className="text-xs text-faint shrink-0 sm:order-1">© {CURRENT_YEAR} {BRAND_NAME}. All rights reserved.</span>
          <span className="inline-flex items-center justify-center gap-1.5 text-xs text-faint sm:order-2 sm:flex-1">
