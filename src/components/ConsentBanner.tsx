...
export function ConsentBanner(): JSX.Element {
  ...
  // The outer live region persists across all render paths so AT establishes it
  // before any content appears. Content changes inside the same DOM node, ensuring
  // AT announces transitions including the reset path (cookie button back to banner).
  return (
    <div aria-live="polite" aria-atomic="true">
      {!mounted ? null : consent !== null ? (
        <button
          type="button"
          onClick={reset}
