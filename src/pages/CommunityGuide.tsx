      ...
      <div className="mx-auto max-w-3xl px-6 pt-28 pb-24">
        ...
        <div className="mt-12 space-y-12">
          ...
          <section aria-labelledby="quick-start">
            <h2 id="quick-start" className="text-xl font-bold text-foreground mb-3">Quick Start</h2>
          ...
          <section aria-labelledby="docs">
            <h2 id="docs" className="text-xl font-bold text-foreground mb-5">Docs</h2>
            <div className="space-y-6">

              <div>
                <h3 className="text-sm font-semibold text-foreground mb-2">Participation</h3>
                <ul className="space-y-1.5">
                  {[
              ...
              <div>
                <h3 className="text-sm font-semibold text-foreground mb-2">Policies</h3>
                <ul className="space-y-1.5">
                  {[
              ...
              <div>
                <h3 className="text-sm font-semibold text-foreground mb-2">Challenges</h3>
                <ul className="space-y-1.5">
                  {[
          ...
          <section aria-labelledby="contact">
            <h2 id="contact" className="text-xl font-bold text-foreground mb-3">Contact</h2>
