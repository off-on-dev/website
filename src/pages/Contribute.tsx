            ...
            <SidebarLayout aside={<CommunityLeaders />}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-5 rounded-lg border border-border bg-card flex flex-col gap-3">
                  ...
                  <p className="text-sm text-dim leading-relaxed flex-1">
                    <a href={`${COMMUNITY_URL}/c/public-categories/q-a/10`} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>Ask a question <ExternalLink size={12} aria-hidden="true" /></a>{" "}or answer one, take part in discussions, and support newcomers getting started. Share tutorials, post tips, and write about what you have learned. Introduce the community to open source tools you use or maintain.
                  </p>
                  <a href={`${COMMUNITY_URL}/c/community-voices/38`} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>
                    Post in Community Voices <ExternalLink size={12} aria-hidden="true" />
                  </a>
                </div>
                ...
                <div className="p-5 rounded-lg border border-border bg-card flex flex-col gap-3">
                  ...
                  <a href={`${COMMUNITY_URL}/tag/weekly-digest/95`} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>
                    Read the weekly digest <ExternalLink size={12} aria-hidden="true" />
                  </a>
                </div>
                ...
                <div className="p-5 rounded-lg border border-border bg-card flex flex-col gap-3">
                  ...
                  <a href={`${COMMUNITY_URL}/c/local-meetups-and-groups/19`} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>
                    Explore meetups and groups <ExternalLink size={12} aria-hidden="true" />
                  </a>
                </div>
                ...
                <div className="p-5 rounded-lg border border-border bg-card flex flex-col gap-3">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" aria-label="LinkedIn" className="social-icon-link">
                    ...
                    <a href={BLUESKY_URL} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" aria-label="Bluesky" className="social-icon-link">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="w-4 h-4" fill="currentColor">
                    ...
                    <a href={X_URL} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" aria-label="X / Twitter" className="social-icon-link">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="w-4 h-4" fill="currentColor">
                ...
                <div className="p-5 rounded-lg border border-border bg-card flex flex-col gap-3">
                  ...
                  <a href="https://github.com/off-on-dev/website/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>
                    Contribute to the website <ExternalLink size={12} aria-hidden="true" />
                  </a>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-col gap-1.5">
                  <a href={`${COMMUNITY_URL}/c/general/site-feedback/2`} target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>
                    Post in Site Feedback <ExternalLink size={12} aria-hidden="true" />
                  </a>
                  <a href="https://github.com/off-on-dev/website/issues" target="_blank" rel="noopener noreferrer" aria-describedby="new-tab-hint" className={extLink}>
                    Open a GitHub issue <ExternalLink size={12} aria-hidden="true" />
                  </a>
                </div>
              </div>
              </div>
